...
Nodes = [ 
    {
        "id": "1",
        "type": "startingPoint",
        "data": { "label": "Starting point", "id": "1" }
    },
    {
        "id": "2",
        "type": "askName",
        "data": { "label": "Ask for a name", "id": "2" }
    },
    {
        "id": "3",
        "type": "askPhone",
        "data": { "label": "Ask for a phone", "id": "3" }
    },
]
Edges = [ 
...
if __name__ == "__main__":
    ...
    router = generate_router_function(nodes, edges)
    
    print(router("1"))  # Should return "askName"
    print(router("2"))  # Should return "askPhone"
    print(router("3"))  # Should return "END"
    print(router("4"))  # Should return "startingPoint" (default)